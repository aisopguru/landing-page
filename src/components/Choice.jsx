...
const Choice = () => {
    ...
    return (
        <section name='About' className='my-[30px] mt-20 xl:mt-0' data-aos='fade-up' data-aos-offset='150'>
            <div className='container mx-auto'>
                <div className='bg-[#fbbf24]/[4%] rounded-[15px] min-h-[560px] px-12 pb-12 flex flex-col text-center xl:flex-row xl:items-center xl:text-left  xl:gap-x-[60px]  xl:pb-0'>
                    <div className='flex-1' data-aos='zoom-in-left'>
                        <img src={image} alt="" height='1000px' width='600px'/>
                    </div>
                    <div className='flex-1 xl:pr-12 flex flex-col items-center'>
